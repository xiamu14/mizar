...
//            );
            ...
            reactContext
                    .getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
                    .emit(this.Key+eventName, params); // Key 通过 setKey 方法注入
...
@ReactProp(name = "Key")
...
> 参考第三方组件： [PullLayout.java](https://github.com/wuyunqiang/AndroidToRN/blob/master/testApp/app/src/main/java/com/example/wuyunqiang/testapp/rnview/PullLayout.java)
